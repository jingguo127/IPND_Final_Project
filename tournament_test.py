...
def testStandingsBeforeMatches():
    ...
    [(id1, name1, wins1, draws1, matches1, opscore1,score1), (id2, name2, wins2, draws2, matches2, opscore2,score2)] = standings
    if matches1 != 0 or matches2 != 0 or wins1 != 0 or wins2 != 0 or draws1 !=0 or draws2 !=0 or opscore1 !=0 or opscore2 !=0 or score1 !=0 or score2 !=0:
        raise ValueError(
...
def testReportMatches():
    ...
    standings = playerStandings(1)
    for (i, n, w, d, m, o, s) in standings:
        if m != 1:
