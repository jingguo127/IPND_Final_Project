...
def testStandingsBeforeMatches():
    ...
    [(id1, name1, score1, opscore1, wins1, loses1, draws1), (id2, name2, score2, opscore2, wins2, loses2,draws2)] = standings
    if score1 != 0 or score2 != 0 or opscore1 != 0 or opscore2 != 0 or wins1 !=0 or wins2 !=0 or loses1 !=0 or loses2 !=0 or draws1 !=0 or draws2 !=0:
        raise ValueError(
...
def testReportMatches():
    ...
    reportMatch(id3, id4)
    standings = playerStandings(1)
    for (i, n, s, o, w, l, d) in standings:
        if w+l+d != 1:
